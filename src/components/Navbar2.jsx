          ...
          <div className=" flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <a
                  href="#about"
                  className="pr-4 border-r tracking-widest hover:text-gray-400 items-center title-font  font-medium text-white mb-4 md:mb-0 ml-3 text-2xl"
                >
                  ROSSETTI
                </a>
              </div>
              <div className="hidden md:block">
                <div className="pt-1 ml-10 flex items-baseline space-x-4">
                  <a
                    href="#projects"
                    className="mr-1 hover:text-white text-gray-300"
                  >
                    Past Work
                  </a>
                  ...
                  <a
                    href="#skills"
                    className="mr-5 hover:text-white text-gray-300"
                  >
                    Skills
                  </a>
                  <a
            ...
            <div className="hidden md:justify-between md:flex md:absolute md:w-20 md:right-72 md:pt-2 xl:right-96 icons">
              <a
                target="_blank"
                className=" m-0"
                href="https://www.linkedin.com/in/rasmus-rossetti-b91701141/"
              >
                <FontAwesomeIcon
                  className=" hover:text-white text-2xl text-gray-300"
                  icon={faLinkedin}
                />
              </a>
              <a
                target="_blank"
                className=" m-0"
                href="https://github.com/RasmusRossetti"
              >
                {" "}
                <FontAwesomeIcon
            ...
            <div className=" pl-2 md:hidden" id="mobile-menu">
              <div ref={ref} className=" px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <div className=" justify-between w-20 flex pl-3  pt-2 icons">
                  ...
                  <a target="_blank" href="https://github.com/RasmusRossetti">
                    {" "}
                    <FontAwesomeIcon
                      className=" text-2xl  text-gray-300 hover:text-white"
                      icon={faGithub}
